...
import { ClientConversorYen } from "./ClientConversorYen";
    ...
    <article className="mx-auto max-w-3xl px-4 py-12">
      ...
      <JsonLd
        data={{
          ...
          mainEntity: {
            "@type": "Dataset",
            name: "Conversor de Tipo de cambio EUR/JPY",
            description: "Herramienta viva para calcular el tipo de cambio entre el euro y el yen japonés.",
          },
        }}
      />
    </article>
